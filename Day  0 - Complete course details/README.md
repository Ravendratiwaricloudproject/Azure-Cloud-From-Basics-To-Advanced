# Azure Cloud From Basics To Advanced Complete Course Details

Day-1: Introduction to the Cloud

We will understand what the cloud is, what cloud computing means, why it’s needed, the scenario before the cloud, cloud service models (IaaS, PaaS, SaaS), and cloud deployment models such as public, private, hybrid, and community clouds. we will also understand about Region and Availability zone(AZ).
...
We will understand ARM, resource groups, and resource in very detail.
...
We will create a Linux VM and install/configure the NGINX web server.

Day-8: Azure Windows Virtual Machine (VM)

We will create a Windows VM and install/configure the IIS web server.
...
We will understand the different Azure load balancing services and their use cases.

Day-13: Azure Load Balancer Demo

We will explore Azure Load Balancer and perform a real-time traffic distribution demo.

Day-14: Azure Application Gateway (Layer-7 Load Balancer) Demo
